...
בדוח, סמנו ממצאים ולחצו **העתקת בקשה ל־Codex / Claude**. הדביקו את הבקשה בשיחה עם הסוכן שיש לו גישה לפרויקט האתר. הבקשה כוללת רק את הבחירה שלכם; לאחר שינוי הבחירה, העתיקו שוב.
